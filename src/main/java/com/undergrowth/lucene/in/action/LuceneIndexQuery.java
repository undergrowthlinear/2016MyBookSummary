 ...
 * @author zhangwu
 * @version 1.0.0
 * @description Lucene的索引构建步骤 createIndex //1.创建Directory //2.创建IndexWriter //3.创建Document
 * //4.为Document创建Field //5.使用IndexWriter将Document写入索引 //6.关闭InderWriter
 *
 * Lucene查询 //1.创建Directory //2.创建IndexReader //3.使用IndexReader创建IndexSearcher //4.创建Query
 * //5.使用IndexSearcher搜索Query,返回TopDocs //6.显示TopDocs的ScoreDoc //7.通过IndexReader/docId获取Document
 * //8.通过Document的get获取字段 //9.关闭IndexReader
